...
FMatrix4::FMatrix4(float p_element1, float p_element2, float p_element3, float p_element4, float p_element5, float p_element6, float p_element7, float p_element8, float p_element9, float p_element10, float p_element11, float p_element12, float p_element13, float p_element14, float p_element15, float p_element16)
{
	data[0] = p_element1;
	data[1] = p_element2;
	data[2] = p_element3;
...
FMatrix4::FMatrix4(const FMatrix4& p_other)
{
	*this = p_other;
}
...
FVector4 FMatrix4::Multiply(const FMatrix4& p_matrix, const FVector4& p_vector)
{
	FVector4 multiply;
...
float FMatrix4::GetMinor(float p_minor0, float p_minor1, float p_minor2, float p_minor3, float p_minor4, float p_minor5, float p_minor6, float p_minor7, float p_minor8)
{
...
FMatrix4 FMatrix4::Translate(const FMatrix4& p_matrix, const FVector3& p_translation)
{
...
FMatrix4 FMatrix4::Rotate(const FMatrix4& p_matrix, const FQuaternion& p_quaternion)
{
	return p_matrix * Rotation(p_quaternion);
}

FMatrix4 FMatrix4::CreatePerspective(const float p_fov, const float p_aspectRatio, const float p_zNear, const float p_zFar)
{
...
FMatrix4 FMatrix4::CreateOrthographic(const float p_size, const float p_aspectRatio, const float p_zNear, const float p_zFar)
{
...
FMatrix4 FMatrix4::CreateView(const float p_eyeX, const float p_eyeY, const float p_eyeZ, const float p_lookX, const float p_lookY, const float p_lookZ, const float p_upX, const float p_upY, const float p_upZ)
{
...
FMatrix4 FMatrix4::CreateFrustum(const float p_left, const float p_right, const float p_bottom, const float p_top, const float p_zNear, const float p_zFar)
{
