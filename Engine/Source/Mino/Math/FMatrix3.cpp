...
FMatrix3::FMatrix3(float p_element1, float p_element2, float p_element3, float p_element4, float p_element5, float p_element6, float p_element7, float p_element8, float p_element9)
{
	data[0] = p_element1;
	data[1] = p_element2;
	data[2] = p_element3;
...
FMatrix3::FMatrix3(const FMatrix3& p_other)
{
	*this = p_other;
}
...
FMatrix3 FMatrix3::Add(const FMatrix3& p_left, const FMatrix3& p_right)
{
	FMatrix3 result(p_left);
	for (uint8_t i = 0; i < 9; ++i)
...
FMatrix3 FMatrix3::Subtract(const FMatrix3& p_left, const FMatrix3& p_right)
{
	FMatrix3 result(p_left);
	for (uint8_t i = 0; i < 9; ++i)
		result.data[i] -= p_right.data[i];
...
FVector3 FMatrix3::Multiply(const FMatrix3& p_matrix, const FVector3& p_vector)
{
	FVector3 result;
...
FMatrix3 FMatrix3::Divide(const FMatrix3& p_left, const FMatrix3& p_right)
{
...
FMatrix3 FMatrix3::Translate(const FMatrix3& p_matrix, const FVector2& p_translation)
{
...
FMatrix3 FMatrix3::Rotate(const FMatrix3& p_matrix, float p_rotation)
{
...
FMatrix3 FMatrix3::Scale(const FMatrix3& p_matrix, const FVector2& p_scale)
{
