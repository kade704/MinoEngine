...
FQuaternion::FQuaternion(float p_real) :
...
FQuaternion FQuaternion::LookAt(const FVector3& p_forward, const FVector3& p_up)
{
...
float FQuaternion::DotProduct(const FQuaternion& p_left, const FQuaternion& p_right)
{
	return
		p_left.x * p_right.x +
		p_left.y * p_right.y +
...
std::pair<FVector3, float> FQuaternion::GetAxisAndAngle(const FQuaternion& p_target)
{
	return std::pair<FVector3, float>(GetRotationAxis(p_target), GetAngle(p_target));
}

float FQuaternion::AngularDistance(const FQuaternion& p_left, const FQuaternion& p_right)
{
	float innerProd = (p_left | p_right);
	return acos((2.0f * innerProd * innerProd) - 1.0f);
}

FQuaternion FQuaternion::Lerp(const FQuaternion& p_start, const FQuaternion& p_end, float p_alpha)
{
...
FQuaternion FQuaternion::Slerp(const FQuaternion& p_start, const FQuaternion& p_end, float p_alpha)
{
...
FQuaternion FQuaternion::Nlerp(const FQuaternion& p_start, const FQuaternion& p_end, float p_alpha)
{
	return Normalize(Lerp(p_start, p_end, p_alpha));
}

FVector3 FQuaternion::RotatePoint(const FVector3& p_point, const FQuaternion& p_quaternion)
{
...
FVector3 FQuaternion::RotatePoint(const FVector3& p_point, const FQuaternion& p_quaternion, const FVector3& p_pivot)
{
