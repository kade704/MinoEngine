...
Shader* Shader::CreateFromSource(const std::string& p_vertexShader, const std::string& p_fragmentShader)
{
...
std::pair<std::string, std::string> Shader::ParseShader(const std::string& path)
{
...
bool Shader::Destroy(Shader*& p_shader)
{
    if (p_shader)
    {
        delete p_shader;
